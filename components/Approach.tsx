  ...
  return (
    <section className="w-full py-20" >
      ...
      justify-center gap-4">
        ...
        dive into coding. From initial sketches to polished code,
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        group-hover/canvas-card:opacity-100 relative z-10 text-center
  ...
  return (
    <div>
        ...
        focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            items-center justify-center rounded-full bg-slate-950 px-5 
            py-2 text-2xl font-bold text-white backdrop-blur-3xl">
                {order}
            </span>
        </button>
    </div>
